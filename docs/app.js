...
async function iniciar() {
  ...
  const ICONOS = {
    ...
    porton: '<svg viewBox="0 0 40 40" width="34" height="34" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M6 35V11Q6 8.5 8.5 8.5H31.5Q34 8.5 34 11V35"/><line x1="10.5" y1="13.5" x2="29.5" y2="13.5"/><line x1="10.5" y1="16" x2="29.5" y2="16"/><line x1="10.5" y1="18.5" x2="29.5" y2="18.5"/><line x1="10.5" y1="21" x2="29.5" y2="21"/><path d="M13.5 32.5V28.5Q13.5 27 15.2 26.8L16.6 24Q17 23.3 17.8 23.3H22.2Q23 23.3 23.4 24L24.8 26.8Q26.5 27 26.5 28.5V32.5"/><line x1="15.2" y1="26.8" x2="24.8" y2="26.8"/><circle cx="12.8" cy="28.2" r="1.1"/><circle cx="27.2" cy="28.2" r="1.1"/><circle cx="16.4" cy="30" r="1.3"/><circle cx="23.6" cy="30" r="1.3"/><rect x="18" y="30.4" width="4" height="1.7" rx="0.5"/><path d="M15.3 32.5V34.5Q15.3 35 15.9 35H16.9Q17.5 35 17.5 34.5V32.5"/><path d="M22.5 32.5V34.5Q22.5 35 23.1 35H24.1Q24.7 35 24.7 34.5V32.5"/></svg>',
