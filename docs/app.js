...
async function iniciar() {
  ...
  const ICONOS = {
    ...
    porton: '<svg viewBox="0 0 40 40" width="34" height="34" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M6 35V11Q6 8.5 8.5 8.5H31.5Q34 8.5 34 11V35"/><line x1="10.5" y1="13.5" x2="29.5" y2="13.5"/><line x1="10.5" y1="16" x2="29.5" y2="16"/><line x1="10.5" y1="18.5" x2="29.5" y2="18.5"/><line x1="10.5" y1="21" x2="29.5" y2="21"/><path d="M9.2 30.72C9.2 27.84 10.4 26.88 12.8 26.88L27.2 26.88C29.6 26.88 30.8 27.84 30.8 30.72L28 30.72Q28 29.2 25.6 29.2Q23.2 29.2 23.2 30.72L16.8 30.72Q16.8 29.2 14.4 29.2Q12 29.2 12 30.72Z"/><path d="M13.44 26.88C13.84 23.36 16.8 22.88 20 22.88C23.2 22.88 26.16 23.36 26.56 26.88"/><line x1="20.32" y1="22.96" x2="20.32" y2="26.88"/><circle cx="14.4" cy="30.9" r="2"/><circle cx="25.6" cy="30.9" r="2"/><circle cx="10.96" cy="28.4" r="0.9"/></svg>',
