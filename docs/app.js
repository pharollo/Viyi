...
async function iniciar() {
  ...
  const ICONOS = {
    ...
    ascensor: '<svg viewBox="0 0 40 40" width="34" height="34" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="8" y="5" width="24" height="30" rx="3.5"/><path d="M15 26V14M12.5 17L15 14l2.5 3"/><path d="M25 14v12M22.5 23L25 26l2.5-3"/></svg>',
