...
async function iniciar() {
  ...
  const ICONOS = {
    ...
    porton: '<svg viewBox="0 0 40 40" width="34" height="34" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M6 35V11Q6 8.5 8.5 8.5H31.5Q34 8.5 34 11V35"/><line x1="10.5" y1="13.5" x2="29.5" y2="13.5"/><line x1="10.5" y1="16" x2="29.5" y2="16"/><line x1="10.5" y1="18.5" x2="29.5" y2="18.5"/><line x1="10.5" y1="21" x2="29.5" y2="21"/><path d="M6.5 31.4C6.5 27.8 8 26.6 11 26.6L29 26.6C32 26.6 33.5 27.8 33.5 31.4L30 31.4Q30 29.5 27 29.5Q24 29.5 24 31.4L16 31.4Q16 29.5 13 29.5Q10 29.5 10 31.4Z"/><path d="M11.8 26.6C12.3 22.2 16 21.6 20 21.6C24 21.6 27.7 22.2 28.2 26.6"/><line x1="20.4" y1="21.7" x2="20.4" y2="26.6"/><circle cx="13" cy="31.6" r="2.4"/><circle cx="27" cy="31.6" r="2.4"/><circle cx="8.7" cy="28.4" r="1"/></svg>',
