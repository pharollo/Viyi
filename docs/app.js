...
async function iniciar() {
  ...
  const ICONOS = {
    ...
    porton: '<svg viewBox="0 0 40 40" width="34" height="34" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M7 35V11Q7 9 9 9H31Q33 9 33 11V35"/><line x1="11" y1="14.5" x2="29" y2="14.5"/><line x1="11" y1="17.5" x2="29" y2="17.5"/><line x1="11" y1="20.5" x2="29" y2="20.5"/><path d="M14.5 34V28Q14.5 25.8 16.7 25.5H23.3Q25.5 25.8 25.5 28V34"/><path d="M17.3 25.5L18.4 22.7Q18.7 22 19.4 22H20.6Q21.3 22 21.6 22.7L22.7 25.5"/><line x1="16.6" y1="29.8" x2="18.3" y2="29.8"/><line x1="21.7" y1="29.8" x2="23.4" y2="29.8"/></svg>',
