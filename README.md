...
5. **Authentication → Settings → Authorized domains**: agrega `pharollo.github.io`.
...
Luego en GitHub: **Settings → Pages → Source: Deploy from a branch → main / `/docs`**. En un minuto la app queda en <https://pharollo.github.io/Viyi/>.
